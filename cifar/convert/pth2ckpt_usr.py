...
def convert_weight(pth_file="../ckpt/cifar10/corruptions/Standard.pt", key_map_path="key_map.txt"):
    """
...
def change_keys(pth_file="../ckpt/cifar10/corruptions/Standard.pt", key_map_path="key_map.txt"):
    """
    convert mae_vit_base_p16 weights from pytorch to mindspore
    pytorch and GPU required.
    """
...
def show_info(pth_file="../ckpt/cifar10/corruptions/Standard.pt"):
    ...
    # standard.pt权重文件中不止有state_dict，一共有：dict_keys(['epoch', 'arch', 'state_dict', 'best_prec1', 'optimizer'])
    ...
    for k, v in state_dict.items():  # state_dict.items():<class 'odict_items'>
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description="cifar weight convert script")
    parser.add_argument("--torch_path",
                        type=str,
                        default="../ckpt/cifar10/corruptions/Standard.pt",
